...
const StorageSelection = ({
 ...
 <Header  />
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-10 w-full">
            {/* Progress Tracker */}
                    <div className="mb-10 sm:mb-16 overflow-x-auto">
                      <div className="flex items-center justify-center gap-6">
                        {[1, 2, 3, 4].map((step, i) => {
                          const isCompleted = step < 4; // step 1 done
                          const isActive = step === 4;  // step 2 active
       ...
       {/* Options */}
<div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2 max-w-lg mx-auto mb-8 sm:mb-12">
    ...
    <button
      ...
      className={`rounded-lg border-2 p-2 sm:p-4 transition cursor-pointer
        ${selectedStorage === storage
          ...
          : 'bg-white border-gray-200 text-gray-900 hover:border-green-500'
        }`}
    >

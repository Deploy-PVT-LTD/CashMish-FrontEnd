        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.04)] border border-white p-8 relative">
            <div className="relative z-10 text-center">
              ...
              <div className="mt-8 px-2 max-w-sm mx-auto">
                <p className="text-sm text-slate-800 font-bold leading-relaxed">
                  <span className="text-slate-900 font-black uppercase tracking-tight text-xs block mb-1">Important Notice:</span> 
                  This quote is a preliminary estimate and may vary based on the actual physical and inspected condition of your device.
                  {!showDisclaimer && (
                    <button 
                      type="button"
                      onClick={() => setShowDisclaimer(true)}
                      className="ml-2 text-blue-600 font-black hover:text-blue-700 cursor-pointer underline underline-offset-4 decoration-blue-200 hover:decoration-blue-600 transition-all text-xs uppercase"
                    >
                      Read More
                    </button>
                  )}
                  ...
                  <div className="mt-4 p-5 bg-slate-50 rounded-[1.5rem] border border-slate-100 text-left transition-all duration-500 animate-in fade-in zoom-in-95">
                    ...
                    <div className="mt-6 pt-4 border-t border-slate-200/50">
                      <button 
                        ...
                        className="text-blue-600 font-black text-[11px] uppercase tracking-wider hover:text-blue-700 cursor-pointer"
                      >
                        Close Details
                      </button>
                    </div>
